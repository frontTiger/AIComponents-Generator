...
export default function CodeTutorial() {
    ...
    useCopilotReadable(codeToDisplay);
        ...
        <>
            <main className=' min-h-screen px-4'>
                ...
                <div className='w-10/12 mx-auto'>
                    <div className='mt-8'>
                        <h1 className='text-nordText text-center text-xl font-semibold p-6'>Code Tutorial</h1>
                        {codeTutorial ? (
                            <Markdown className='text-nordText'>{codeTutorial}</Markdown>
                        ) : (
                            <div className='text-nordText'>The Code Tutorial Will Appear Here</div>
                        )}
                    </div>
                </div>
            </main>
